...
\begin{itemize} \itemsep +4pt
   ...
   Designing cross-platform toolchain building flow to apply security patch, avoid Synology product to suffer security attack.
   Also unify ARM and PowerPC platform toolchain and related issue fix.

   \item {\bf ARM Based SOC Bring Up}\\
   Marvell and STMicroelectronics SOC bring up, including kernel porting, hardware function implementation, performance tuning and relative bug fix.
   Deliver Synology DS115, RS815, DS216Play Model.
