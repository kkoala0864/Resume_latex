...
\begin{itemize} \itemsep +5pt
   ...
   Developing directory service on Synology cloud platform (C2) from scratch, including survey and design product specification, contruct service backend on Kubernetes, and design tool to make user easy to use service.
   ...
   \item {\bf VPN Service}\\
   Maintaining Synology VPN service application, including performance tunning make application 70\% speed up.
