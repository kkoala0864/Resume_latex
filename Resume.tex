...
\begin{itemize} \itemsep +5pt
   ...
   Implementing SRP (Secure Remote Password) protocol as authentication algorithm to avoid store user password at service backend.

   \item {\bf VPN Service}\\
   Maintaining Synology VPN service application, including troubleshooting and performance tunning make application 70\% speed up.
